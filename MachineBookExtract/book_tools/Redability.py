...
class Readability():
    def __init__(self, doc, basicStatistics, content):
        ...
        self.doc = doc
        self.w = self.basicStatistics.get_book_length_words(self.content)
        self.s = len(self.basicStatistics.get_sentences())
    ...
    def getMcLaughlinSMOGRedability(self):
        ...
        w = self.basicStatistics.get_book_length_words(self.content)
        s = len(self.basicStatistics.get_sentences())
